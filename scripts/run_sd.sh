...
CUDA_VISIBLE_DEVICES=0,1 accelerate launch --num_processes 1 benchmark/eval_humaneval.py --eval_mode sd --gamma 8 -n 1  -e test1
...
CUDA_VISIBLE_DEVICES=0,1 accelerate launch --num_processes 1 benchmark/eval_humaneval.py --eval_mode sd --gamma 6 -n 1  -e test3 --draft_model codellama-7b --target_model codellama-34b --max_tokens 1024 --temp 0
