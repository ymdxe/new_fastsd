...
def parse_arguments():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help='canonical evaluation JSONL generated by scripts/eval_suite.py',
    )
    parser.add_argument('--workload_hash', type=str, default=None)
    # mt_bench data path
    ...
    parser.add_argument(
        ...
        default='dataset',
        choices=['dataset', 'eos'],
        help='dataset uses legacy benchmark stop markers; eos uses one shared cross-method policy',
    )
